// Number of users: 341, Number of items: 462, Total interactions: 3147
#define item_num 5149
#define user_num 23715
const char *dataset_path = "./data/Amazon-Software/";
...
PYBIND11_MODULE(pybind_amazon_software, m)
{
