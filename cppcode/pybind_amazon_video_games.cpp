// Number of users: 3564, Number of items: 2168, Total interactions: 55677
#define item_num 2006
#define user_num 3246
const char *dataset_path = "./data/Amazon-Video_Games/";
...
PYBIND11_MODULE(pybind_amazon_video_games, m)
{
