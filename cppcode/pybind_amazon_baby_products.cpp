// Number of users: 7693, Number of items: 3980, Total interactions: 108709
#define item_num 3649
#define user_num 6955
const char *dataset_path = "./data/Amazon-Baby_Products/";
...
PYBIND11_MODULE(pybind_amazon_baby_products, m)
{
